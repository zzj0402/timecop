...
class TimerTypeDial extends StatefulWidget {
  TimerTypeDial({Key key}) : super(key: key);

  @override
  _TimerTypeDialState createState() => _TimerTypeDialState();
}

class _TimerTypeDialState extends State<TimerTypeDial>
