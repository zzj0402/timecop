...
class SettingsBloc extends Bloc<SettingsEvent, SettingsState> {
  ...
  Stream<SettingsState> mapEventToState(
    ...
    } else if (event is SetCountdownDuration) {
      await settings.setInt("countdownDuration", event.duration ?? 42);
      yield SettingsState.clone(state, countdownDuration: event.duration ?? 42);
